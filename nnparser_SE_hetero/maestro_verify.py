...
PP3, P3, PP2, P2, P1 = 1, 1, 1, 1, 224
PQ3, Q3, PQ2, Q2, Q1 = 1, 1, 1, 1, 224
PK3, PK2, K1, PK0 = 1, 64, 1, 1
C1, PC0 = 3 ,1
R0, S0 = 3, 3
...
# storage size
AL1_mem = 18/2 # 神经元个数，按照maestro配置得到的
OL1_mem = 18/2
WL1_mem = 18/2
AL2_mem = 18/2
OL2_mem = 128/2
...
data_flow = ['S0',  'R0',   'P1',  'Q1',   'C1',    'top']
ol1_ratio = [1,     1,      P1,     Q1,     1,       1]
al1_ratio = [S0,    R0,     P1,     Q1,      C1,     1] 
wl1_ratio = [S0,    R0,     1,      1,      C1,      1]
all_param = [S0,    R0,      P1,     Q1,     C1,      1]
out_final = [0,     0,      0,      0,      0,       1]
...
print ("AL2_need", AL2_need)
# 计算得到结果
# AL1_need {'S0': 3, 'R0': 9, 'P1': 678, 'Q1': 51076, 'C1': 153228, 'top': 153228}
# AL2_need {'S0': 3, 'R0': 9, 'P1': 678, 'Q1': 51076, 'C1': 153228, 'top': 153228}

# AL1_need = {'S0': 3, 'R0': 9, 'P1': 224*3, 'Q1': 224*224, 'C1': 224*224*3, 'top': 224*224*3}
# AL2_need = {'S0': 3, 'R0': 9, 'P1': 224*3, 'Q1': 224*224, 'C1': 224*224*3, 'top': 224*224*3}
# 手算结果
# AL1_need {'S0': 3, 'R0': 9, 'P1': 672, 'Q1': 50176, 'C1': 150528, 'top': 150528}
# AL2_need {'S0': 3, 'R0': 9, 'P1': 672, 'Q1': 50176, 'C1': 150528, 'top': 150528}
...
print ("chip_neu_num_wr_opt",chip_neu_num_wr_opt)
print ("chip_neu_num_rd_opt",chip_neu_num_rd_opt)
print ("chip_neu_num_rd_wgt",chip_neu_num_rd_wgt)
print ("chip_neu_num_rd_act",chip_neu_num_rd_act)

print ("core_neu_num_wr_opt",core_neu_num_wr_opt)
print ("core_neu_num_rd_opt",core_neu_num_rd_opt)
print ("core_neu_num_rd_wgt",core_neu_num_rd_wgt)
print ("core_neu_num_rd_act",core_neu_num_rd_act)
